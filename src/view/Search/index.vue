<template>
  <div class="profession">
    ...
    <van-calendar v-model="showPickerDate" :default-date=[yesterday,today] type="range" @confirm="onConfirm"
                  :min-date="minDate" :max-date="maxDate"/>
    <van-popup v-model="showCloudPicker" round position="bottom" :style="{ height: '30%'}">
      <van-stepper
        style="line-height: 100px;margin-left: 100px;"
        v-model="cloudPrecent"
        input-width="40px"
        button-size="32px"
        @change="cloudChange"
      />
    ...
    <div class="resultContent" v-if="state">
      <van-popup class="resultBox" v-model="resultShow" round position="bottom" :style="{ height: '70%'}">
        ...
        <div class="pagination">
          <div class="Tool">
            <van-checkbox class="allCheck" v-model="checkedDataz"  v-if="switchingNameFlag" shape="square" @change="checkedDataAll">
